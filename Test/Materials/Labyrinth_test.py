...
class TestLabyrinth(unittest.TestCase):
    ...
    def test_wall_break(self):
        ...
        self.assertEqual(
            [Lab1.board[0][0].walls["Right"], Lab1.board[0][1].walls["Left"]],
            [False, False],
        )
...
#####""",
    ...
    def test_displayResolver(self):
        ...
        # Create way
        (
            Lab1.board[0][0].in_way,
            Lab1.board[0][1].in_way,
            Lab1.board[1][1].in_way,
            Lab1.board[1][2].in_way,
            Lab1.board[2][2].in_way,
